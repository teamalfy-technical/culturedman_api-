...
const singleBreastedCollection = {
  ...
  "single-breasted-2": {
    ...
    images: [
      {
        src: "/images/corporate/single-breasted/single-breasted-2.png",
  ...
  "single-breasted-3": {
    ...
    images: [
      {
        src: "/images/corporate/single-breasted/single-breasted-3.png",
        alt: "Man in gray pinstripe suit - front view",
      },
      {
        src: "/images/corporate/single-breasted/single-breasted-3-2.png",
        alt: "Man in gray pinstripe suit - side view",
      },
      {
        src: "/images/corporate/single-breasted/single-breasted-3-3.png",
  ...
  "single-breasted-4": {
    ...
    images: [
      {
        src: "/images/corporate/single-breasted/single-breasted-4.png",
...
export default function SingleBreastedItemPage() {
  const params = useParams()
  const id = params.id as string
  const item = singleBreastedCollection[id as keyof typeof singleBreastedCollection]
  ...
  return (
    <PageLayout>
      <ProductDetail
        ...
        images={item.images}
        backLink="/pages/categories/corporate/single-breasted"
