...
export default function SafariSuitPage() {
  return (
    <PageLayout>
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-black my-4 text-center flex-1">Safari Suits</h1>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          {safariSuitCollection.map((item) => (
